...
function managerInfo () {
    ...
    return inquirer.prompt([
        ...
        const newManager = new Manager(managerData.name, managerData.id, managerData.email, manager.officeNumber);
...
function engineerInfo() {
    ...
    return inquirer.prompt([
        ...
        const newEngineer = new Engineer(engineerData.name, engineerData.id, engineer.email, engineerData.gitHub);
